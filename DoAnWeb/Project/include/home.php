...
<div class="small-container">
    ...
    <div class="row">
        ...
        for ($i = 0; $i < 4; $i++) {
            $bestSell = mysqli_fetch_array($sql_bestSell);
        ?>
            <div class="col-4">
                ...
                <div>
                    ...
                    <p><?php echo '$' . number_format($bestSell['product_price']); ?></p>
                </div>
            </div>
        <?php
        }
    ...
    <div class="row">
        ...
        for ($i = 0; $i < 8; $i++) {
            $lastProduct = mysqli_fetch_array($sql_lastSell);
        ?>
            <div class="col-4">
                <div class="p-relative">
                        ...
                        <div class="block-addtocart">
                            ...
                            <script>
                                function pop_up() {
                                    ...
                                    el.innerHTML += "<input class=\"a-swal\" type = \"submit\" value =\"Continue Shopping\">";
                ...
                <div>
                    ...
                    <p><?php echo '$' . number_format($lastProduct['product_price']); ?></p>
                </div>
            </div>
        <?php
        }
