                      ...
                      <table style="border:1px solid grey; width: 100%;" class="table table-bordered">
                          <thead class="thead-dark">
                              <tr>
                                  ...
                                  <th style="background-color: unset; color:black;">Total Price(With tax and shipping)</th>
                                  <th style="background-color: unset; color:black;">Date</th>
                                  <th style="background-color: unset; color:black;">Status</th>
                                  <th style="background-color: unset; color:black; text-align:left;"></th>
                              </tr>
                          </thead>
                          <tbody>
                              <?php
                      ...
                      <div class="col-2">
                          <div class="form-container">
                              ...
                              <form id="RegForm" action="?control=register" method="POST">
                                  ...
                                  <div id="textPass"></div>
                                  <button type="submit" class="btn" onsubmit="return checkForTheCondition();">Register</button>
                                  <div style="padding: 8px;">
