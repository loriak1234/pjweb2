...
?>
    <div class="small-container single-product">
        <div class="row" style="align-items: unset; flex-wrap:unset; flex-basis: 55%;">
            <div class="col-2">
                <img style="height: 475px" src="images/<?php echo $row_productDetail['product_image'] ?>" width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img style="height: 114px" src="images/<?php echo $row_productDetail['product_image'] ?>" width="100%" class="small-img">
                    </div>
                    <?php
                    ...
                    ?>
                        <div class="small-img-col">
                            <img style="height: 114px" src="images/<?php echo $row_imageDetail['img_detail'] ?>" width="100%" class="small-img">
                        </div>
                    <?php
                    }
                    ?>
            ...
            <form action="?control=cart" method="POST" id="cartDetailForm" style="flex-basis: 45%;">
                <div class="col-2">
