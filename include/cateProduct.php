...
WHERE category.category_id = product.category_id AND product.category_id = '$id' AND product_active = 1 " . $orderCondition .
    ...
    <div style="justify-content: start; align-items: unset;" class="row">
        <?php
                ...
                <div class="border-product">
                    <div class="p-relative">
                        <a href="?control=detail&id=<?php echo $col_product['product_id'] ?>">
                            <img style="height: 237.5px; background-color:#6e6e6e1a;" src="images/<?php echo $col_product['product_image']; ?>">
                        </a>
...
ORDER BY product_id asc";
    ...
    $lpm1 = $maxPage - 1;
    $self = "?control=category&id=$id" . $param;
    $nav  = '';
    ?>
